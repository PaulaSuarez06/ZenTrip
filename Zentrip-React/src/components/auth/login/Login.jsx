...
export default function Login() {
  ...
  return (
    <>
      ...
      {imagenCargada && (
        <div className={`h-dvh md:min-h-screen flex items-center justify-center bg-slate-50 px-4 md:px-8 lg:px-16 ${hasLoginMessage ? 'overflow-y-auto' : 'overflow-hidden'} md:overflow-y-auto`}>
