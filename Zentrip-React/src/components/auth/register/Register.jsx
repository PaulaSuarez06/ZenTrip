...
export default function Register() {
    ...
    return (
        <div className={`h-dvh md:min-h-screen flex items-center justify-center bg-brand-white px-4 ${hasRegisterMessage ? 'overflow-y-auto' : 'overflow-hidden'} md:overflow-y-auto`}>
