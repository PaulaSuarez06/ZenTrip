        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="body-2-semibold text-neutral-7">{booking.hotelName}</p>
                <p className="body-3 text-neutral-4">
                  {fmtDate(booking.checkIn)} → {fmtDate(booking.checkOut)} · {booking.nights} noche{booking.nights !== 1 ? 's' : ''}
                </p>
              </div>
            </div>
            {booking.pricePerNight != null && (
              <div className="text-right shrink-0">
                <p className="body-2-semibold text-auxiliary-green-5">
                  {booking.pricePerNight} {booking.currency}<span className="body-3 font-normal"> /noche</span>
                </p>
