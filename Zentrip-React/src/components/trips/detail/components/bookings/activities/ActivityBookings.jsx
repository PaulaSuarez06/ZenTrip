      ...
      <div className="p-4 sm:p-6">
        {bookings.length > 0 ? (
          ...
          <div className="text-center py-10 mb-7">
            ...
            <p className="body-2-semibold text-neutral-6 mb-1">Sin actividades anotadas</p>
            <p className="body-3 text-neutral-4">Usa el itinerario para buscar y anotar actividades</p>
          </div>
        )}

        <button
          onClick={() => onGoBook?.('actividades')}
        ...
        >
          <div className="w-9 h-9 rounded-full bg-primary-1 group-hover:bg-primary-2 flex items-center justify-center transition shrink-0">
            <Compass className="w-4 h-4 text-primary-4" />
          </div>
          <div className="text-left">
            <p className="body-3 font-bold text-primary-4">Buscar actividades</p>
